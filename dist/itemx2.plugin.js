...
//@display-name ITEMX CODEX · v1.9.0-beta.15
...
const ITEMX_PLUGIN_VERSION = '1.9.0-beta.15';
const ITEMX_VERSION_LABEL = '1.9 · BETA 15';
...
.itemx2-codex-fx{position:absolute;pointer-events:none;contain:paint;--fx:#79b9ff;--fx2:#a47dff;--fx-duration:6s}.itemx2-codex-list-fx{z-index:0;inset:0;background:radial-gradient(circle at 92% 18%,color-mix(in srgb,var(--fx) 26%,transparent),transparent 38%),linear-gradient(105deg,transparent 55%,color-mix(in srgb,var(--fx2) 12%,transparent));opacity:.82;animation:itemx2-codex-breathe var(--fx-duration) ease-in-out infinite}.itemx2-codex-hero-fx{z-index:0;inset:0;overflow:hidden}.itemx2-codex-hero-fx i,.itemx2-codex-hero-fx b,.itemx2-codex-hero-fx em{position:absolute;display:block;font-style:normal}.itemx2-codex-hero-fx i{inset:12% 18%;border:1px solid color-mix(in srgb,var(--fx) 48%,transparent);border-radius:50%;box-shadow:0 0 30px color-mix(in srgb,var(--fx) 25%,transparent);animation:itemx2-codex-spin var(--fx-duration) linear infinite}.itemx2-codex-hero-fx b{inset:27% 8%;background:repeating-conic-gradient(from 20deg,color-mix(in srgb,var(--fx2) 32%,transparent) 0 2deg,transparent 2deg 31deg);mask:radial-gradient(circle,transparent 54%,#000 56% 58%,transparent 60%);animation:itemx2-codex-spin calc(var(--fx-duration) * 1.45) linear infinite reverse}.itemx2-codex-hero-fx em{left:8%;right:8%;bottom:5%;height:34%;background:radial-gradient(ellipse at 50% 100%,color-mix(in srgb,var(--fx) 28%,transparent),transparent 68%);filter:blur(8px);animation:itemx2-codex-breathe calc(var(--fx-duration) * .75) ease-in-out infinite}
.itemx2-skill-theme-fire{--fx:#ff7a3d;--fx2:#ffd067}.itemx2-skill-theme-ice{--fx:#83e8ff;--fx2:#9baeff}.itemx2-skill-theme-lightning{--fx:#9dc5ff;--fx2:#eee86b}.itemx2-skill-theme-dark{--fx:#946bdb;--fx2:#d65fe8}.itemx2-skill-theme-light{--fx:#ffe99c;--fx2:#fff}.itemx2-skill-theme-arcane{--fx:#68b7ff;--fx2:#a679ff}.itemx2-skill-type-active{--fx-duration:4.4s}.itemx2-skill-type-passive{--fx-duration:9s}.itemx2-skill-type-sealed,.itemx2-skill-status-sealed{--fx-duration:13s;filter:saturate(.48);opacity:.46}.itemx2-skill-status-equipped{filter:brightness(1.2)}.itemx2-skill-status-lost{animation:none!important;opacity:.22;filter:grayscale(1)}.itemx2-skill-status-lost *{animation:none!important}
.itemx-skill-hero::before,.itemx-skill-hero::after{display:none!important}.itemx-skill-hero .itemx2-skill-hero-fx i,.itemx-skill-hero .itemx2-skill-hero-fx b,.itemx-skill-hero .itemx2-skill-hero-fx em{inset:auto;border:0;border-radius:0;box-shadow:none;mask:none;filter:none;transform:none}.itemx-skill-hero .itemx2-skill-hero-fx em{animation:none}
.itemx2-skill-theme-fire.itemx2-skill-list-fx{background:linear-gradient(165deg,transparent 48%,rgba(255,94,35,.12)),repeating-linear-gradient(76deg,transparent 0 14px,rgba(255,196,74,.13) 15px,transparent 17px);clip-path:polygon(58% 100%,66% 33%,72% 83%,80% 16%,86% 77%,95% 43%,100% 100%)}.itemx-skill-theme-fire .itemx2-skill-hero-fx i{left:5%;right:5%;bottom:0;height:60%;background:linear-gradient(0deg,rgba(255,76,25,.34),rgba(255,176,57,.14) 48%,transparent);clip-path:polygon(0 100%,8% 54%,15% 88%,23% 24%,31% 81%,42% 41%,50% 93%,61% 16%,69% 79%,80% 33%,88% 87%,100% 47%,100% 100%);animation:itemx2-skill-flame var(--fx-duration) ease-in-out infinite alternate}.itemx-skill-hero.itemx2-skill-theme-fire .itemx2-skill-hero-fx b{inset:12% 8% 28%;background:radial-gradient(circle at 16% 82%,#ffd56a 0 2px,transparent 3px),radial-gradient(circle at 72% 66%,#ff7838 0 2px,transparent 3px),radial-gradient(circle at 88% 25%,#ffd56a 0 1px,transparent 2px),radial-gradient(circle at 38% 20%,#ff7838 0 1px,transparent 2px);animation:itemx2-skill-embers calc(var(--fx-duration) * .8) linear infinite}.itemx-skill-hero.itemx2-skill-theme-fire .itemx2-skill-hero-fx em{left:8%;right:8%;bottom:2%;height:18%;background:linear-gradient(0deg,rgba(255,78,28,.3),transparent);filter:blur(7px)}
.itemx2-skill-theme-ice.itemx2-skill-list-fx{background:linear-gradient(126deg,transparent 0 62%,rgba(116,225,255,.13) 63% 65%,transparent 66%),linear-gradient(48deg,transparent 0 75%,rgba(160,186,255,.15) 76% 78%,transparent 79%)}.itemx-skill-hero.itemx2-skill-theme-ice .itemx2-skill-hero-fx i{inset:6%;background:repeating-linear-gradient(128deg,transparent 0 31px,rgba(147,232,255,.2) 32px 33px,transparent 34px 47px),repeating-linear-gradient(52deg,transparent 0 42px,rgba(143,171,255,.13) 43px 44px,transparent 45px 63px);clip-path:polygon(0 16%,42% 0,100% 18%,87% 83%,57% 100%,8% 78%);animation:itemx2-skill-ice-glint var(--fx-duration) ease-in-out infinite}.itemx-skill-hero.itemx2-skill-theme-ice .itemx2-skill-hero-fx b{right:5%;top:9%;width:39%;height:64%;background:linear-gradient(145deg,rgba(188,246,255,.34),rgba(118,151,255,.06));clip-path:polygon(48% 0,100% 32%,65% 100%,36% 63%,0 74%,25% 34%);animation:itemx2-skill-shard calc(var(--fx-duration) * 1.1) ease-in-out infinite}.itemx-skill-hero.itemx2-skill-theme-ice .itemx2-skill-hero-fx em{left:6%;right:6%;bottom:8%;height:2px;background:linear-gradient(90deg,transparent,#9beaff,transparent);box-shadow:0 0 12px rgba(126,214,255,.55)}
.itemx2-skill-theme-lightning.itemx2-skill-list-fx{background:linear-gradient(117deg,transparent 0 68%,rgba(229,239,95,.2) 69% 71%,transparent 72% 76%,rgba(128,183,255,.18) 77% 79%,transparent 80%);animation:itemx2-skill-flash calc(var(--fx-duration) * .7) steps(1,end) infinite}.itemx-skill-hero.itemx2-skill-theme-lightning .itemx2-skill-hero-fx i{left:9%;top:6%;width:62%;height:88%;background:linear-gradient(180deg,#e8ee75,#74aeff);clip-path:polygon(51% 0,38% 38%,57% 34%,20% 100%,35% 55%,17% 59%);animation:itemx2-skill-flash calc(var(--fx-duration) * .55) steps(1,end) infinite}.itemx-skill-hero.itemx2-skill-theme-lightning .itemx2-skill-hero-fx b{right:4%;top:16%;width:48%;height:72%;background:rgba(133,193,255,.72);clip-path:polygon(73% 0,46% 34%,64% 32%,25% 100%,43% 51%,25% 54%);animation:itemx2-skill-flash calc(var(--fx-duration) * .73) .18s steps(1,end) infinite}.itemx-skill-hero.itemx2-skill-theme-lightning .itemx2-skill-hero-fx em{inset:10%;background:repeating-linear-gradient(90deg,transparent 0 35px,rgba(113,178,255,.06) 36px),repeating-linear-gradient(0deg,transparent 0 27px,rgba(226,239,103,.05) 28px)}
.itemx2-skill-theme-dark.itemx2-skill-list-fx{background:linear-gradient(110deg,transparent 38%,rgba(107,55,161,.2) 66%,rgba(19,8,32,.42));clip-path:polygon(42% 0,100% 0,100% 100%,55% 100%,72% 64%,49% 48%,70% 31%)}.itemx-skill-hero.itemx2-skill-theme-dark .itemx2-skill-hero-fx i{left:-14%;top:6%;width:92%;height:88%;background:linear-gradient(115deg,transparent 4%,rgba(102,48,147,.28) 38%,rgba(11,5,21,.78) 75%);clip-path:polygon(0 22%,78% 0,48% 34%,100% 52%,38% 67%,74% 100%,0 78%);animation:itemx2-skill-shadow var(--fx-duration) ease-in-out infinite alternate}.itemx-skill-hero.itemx2-skill-theme-dark .itemx2-skill-hero-fx b{right:-8%;top:0;width:70%;height:100%;background:linear-gradient(70deg,transparent,rgba(190,75,225,.13),rgba(5,3,14,.64));clip-path:polygon(53% 0,100% 0,100% 100%,21% 100%,65% 68%,25% 48%,67% 25%);animation:itemx2-skill-shadow calc(var(--fx-duration) * 1.2) ease-in-out infinite alternate-reverse}.itemx-skill-hero.itemx2-skill-theme-dark .itemx2-skill-hero-fx em{inset:0;background:linear-gradient(90deg,rgba(4,2,10,.56),transparent 48%,rgba(4,2,10,.5))}
.itemx2-skill-theme-light.itemx2-skill-list-fx{background:repeating-linear-gradient(104deg,transparent 0 14px,rgba(255,239,153,.12) 15px 16px,transparent 17px 25px);clip-path:polygon(54% 0,100% 0,100% 100%,48% 100%,71% 52%)}.itemx-skill-hero.itemx2-skill-theme-light .itemx2-skill-hero-fx i{left:10%;right:10%;top:0;height:86%;background:repeating-linear-gradient(104deg,transparent 0 22px,rgba(255,244,180,.21) 24px 27px,transparent 29px 42px);clip-path:polygon(24% 0,82% 0,100% 100%,0 100%);animation:itemx2-skill-rays var(--fx-duration) ease-in-out infinite alternate}.itemx-skill-hero.itemx2-skill-theme-light .itemx2-skill-hero-fx b{left:48%;top:3%;width:4px;height:84%;background:linear-gradient(#fff,rgba(255,229,121,.2));box-shadow:0 0 18px rgba(255,240,166,.7);transform:skewX(-9deg)}.itemx-skill-hero.itemx2-skill-theme-light .itemx2-skill-hero-fx em{left:8%;right:8%;bottom:8%;height:32%;background:linear-gradient(0deg,rgba(255,224,119,.18),transparent);clip-path:polygon(15% 100%,48% 0,55% 100%,74% 20%,90% 100%)}
.itemx2-skill-theme-arcane.itemx2-skill-list-fx{background:linear-gradient(135deg,transparent 58%,rgba(91,183,255,.12) 59% 61%,transparent 62%),linear-gradient(45deg,transparent 72%,rgba(169,116,255,.14) 73% 75%,transparent 76%)}.itemx-skill-hero.itemx2-skill-theme-arcane .itemx2-skill-hero-fx i{left:23%;top:4%;width:54%;height:76%;background:linear-gradient(135deg,rgba(95,187,255,.25),rgba(166,110,255,.08));clip-path:polygon(50% 0,100% 50%,50% 100%,0 50%,7% 50%,50% 8%,93% 50%,50% 92%,7% 50%,0 50%);animation:itemx2-skill-diamond var(--fx-duration) ease-in-out infinite}.itemx-skill-hero.itemx2-skill-theme-arcane .itemx2-skill-hero-fx b{inset:13% 7%;background:repeating-linear-gradient(90deg,transparent 0 34px,rgba(106,181,255,.08) 35px),repeating-linear-gradient(0deg,transparent 0 28px,rgba(164,108,255,.07) 29px);clip-path:polygon(50% 0,100% 50%,50% 100%,0 50%)}.itemx-skill-hero.itemx2-skill-theme-arcane .itemx2-skill-hero-fx em{left:12%;right:12%;bottom:7%;height:2px;background:linear-gradient(90deg,transparent,#87bfff,#c084ff,transparent);animation:itemx2-skill-scan var(--fx-duration) ease-in-out infinite}
.itemx2-encounter-theme-beast{--fx:#e7aa61;--fx2:#d85d4d}.itemx2-encounter-theme-undead{--fx:#8ed9c2;--fx2:#7c62a8}.itemx2-encounter-theme-construct{--fx:#75b9d6;--fx2:#b3ccd4}.itemx2-encounter-theme-dragon{--fx:#ff674b;--fx2:#efb74e}.itemx2-encounter-theme-aquatic{--fx:#49c9dc;--fx2:#557fe9}.itemx2-encounter-theme-insect{--fx:#9bc15e;--fx2:#d8b85a}.itemx2-encounter-theme-unknown{--fx:#bf687a;--fx2:#73849f}.itemx2-encounter-theme-beast.itemx2-codex-list-fx{background:linear-gradient(115deg,transparent 68%,color-mix(in srgb,var(--fx) 20%,transparent)),repeating-linear-gradient(70deg,transparent 0 13px,color-mix(in srgb,var(--fx2) 14%,transparent) 14px 15px)}.itemx2-encounter-theme-undead.itemx2-codex-list-fx,.itemx2-encounter-theme-aquatic.itemx2-codex-list-fx{background:radial-gradient(ellipse at 85% 80%,color-mix(in srgb,var(--fx) 30%,transparent),transparent 48%)}.itemx2-encounter-theme-construct.itemx2-codex-list-fx{background:repeating-linear-gradient(90deg,transparent 0 20px,color-mix(in srgb,var(--fx) 11%,transparent) 21px),repeating-linear-gradient(0deg,transparent 0 15px,color-mix(in srgb,var(--fx2) 8%,transparent) 16px)}.itemx2-encounter-theme-dragon.itemx2-codex-list-fx{background:radial-gradient(circle at 90% 50%,color-mix(in srgb,var(--fx) 32%,transparent),transparent 38%)}.itemx2-encounter-theme-insect.itemx2-codex-list-fx{background:radial-gradient(circle at 82% 32%,color-mix(in srgb,var(--fx) 30%,transparent) 0 2px,transparent 3px),radial-gradient(circle at 94% 61%,color-mix(in srgb,var(--fx2) 26%,transparent) 0 2px,transparent 3px)}.itemx2-threat-1{opacity:.88}.itemx2-threat-2{filter:brightness(1.12)}.itemx2-threat-3{filter:brightness(1.28) saturate(1.18)}.itemx2-encounter-warning .itemx2-encounter-hero-fx::after{content:'';position:absolute;left:0;right:0;top:12%;height:2px;background:linear-gradient(90deg,transparent,#ff637c,transparent);box-shadow:0 0 16px #ff3d60;animation:itemx2-codex-warning 3s ease-in-out infinite}.itemx2-encounter-sparring{--fx:#6eb8ee;--fx2:#d4b96a}.itemx2-encounter-ended{opacity:.34;filter:grayscale(.65)}.itemx2-encounter-ended,.itemx2-encounter-ended *{animation-play-state:paused!important}
.itemx2-effects-off .itemx2-codex-fx{display:none!important;animation:none!important}.itemx2-effects-off .itemx2-codex-fx *{animation:none!important}@keyframes itemx2-codex-spin{to{transform:rotate(360deg)}}@keyframes itemx2-codex-breathe{0%,100%{opacity:.42}50%{opacity:1}}@keyframes itemx2-codex-warning{0%,100%{opacity:.15;transform:translateY(0)}50%{opacity:.9;transform:translateY(130px)}}@keyframes itemx2-skill-flame{from{opacity:.48;transform:translate3d(0,5px,0) scaleX(.96)}to{opacity:.9;transform:translate3d(0,-3px,0) scaleX(1.03)}}@keyframes itemx2-skill-embers{from{opacity:.25;transform:translate3d(0,12px,0)}50%{opacity:.95}to{opacity:.18;transform:translate3d(4px,-18px,0)}}@keyframes itemx2-skill-ice-glint{0%,100%{opacity:.38;transform:translate3d(-2px,0,0)}50%{opacity:.82;transform:translate3d(2px,-1px,0)}}@keyframes itemx2-skill-shard{0%,100%{opacity:.35;transform:translate3d(0,2px,0)}50%{opacity:.72;transform:translate3d(-3px,-3px,0)}}@keyframes itemx2-skill-flash{0%,13%,19%,64%,70%,100%{opacity:.18}14%,18%,65%,69%{opacity:1}}@keyframes itemx2-skill-shadow{from{opacity:.42;transform:translate3d(-4px,0,0)}to{opacity:.82;transform:translate3d(7px,-2px,0)}}@keyframes itemx2-skill-rays{from{opacity:.32;transform:translate3d(-3px,0,0)}to{opacity:.78;transform:translate3d(4px,0,0)}}@keyframes itemx2-skill-diamond{0%,100%{opacity:.34;transform:translate3d(0,2px,0) scale(.96)}50%{opacity:.76;transform:translate3d(0,-2px,0) scale(1.02)}}@keyframes itemx2-skill-scan{0%,100%{opacity:.2;transform:translate3d(-12%,0,0)}50%{opacity:.9;transform:translate3d(12%,0,0)}}@media(prefers-reduced-motion:reduce){.itemx2-codex-fx,.itemx2-codex-fx *{animation:none!important}}
`;
...
`;
  ...
  function encounterFxClasses(monster) {
    ...
    const ended = /ended|defeated|lost|종료|격퇴|패배|소실/.test(status) ? 'itemx2-encounter-ended' : '';
