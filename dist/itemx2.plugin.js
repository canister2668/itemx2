...
//@display-name ITEMX CODEX · v1.9.0-beta.16
...
const ITEMX_PLUGIN_VERSION = '1.9.0-beta.16';
const ITEMX_VERSION_LABEL = '1.9 · BETA 16';
...
.itemx2-codex-fx{position:absolute;pointer-events:none;contain:paint;--fx:#78b9ff;--fx2:#a77fff;--fx3:#eef7ff;--fx-speed:8s}.itemx2-codex-list-fx{z-index:0;inset:0;overflow:hidden;opacity:.82;animation:none}.itemx2-codex-hero-fx{z-index:0;inset:0;overflow:hidden}.itemx2-codex-hero-fx i,.itemx2-codex-hero-fx b,.itemx2-codex-hero-fx em{position:absolute;display:block;font-style:normal;pointer-events:none}.itemx-skill-hero::before,.itemx-skill-hero::after,.itemx-monster-hero::before,.itemx-monster-hero::after{display:none!important}
.itemx2-skill-theme-fire{--fx:#ff7b3f;--fx2:#ffbe62;--fx3:#fff0b1}.itemx2-skill-theme-ice{--fx:#83e7f7;--fx2:#8caeff;--fx3:#e9feff}.itemx2-skill-theme-lightning{--fx:#8ebdff;--fx2:#e9ec72;--fx3:#fff}.itemx2-skill-theme-dark{--fx:#774ea7;--fx2:#bd69ce;--fx3:#e4b1ff}.itemx2-skill-theme-light{--fx:#f1dca0;--fx2:#fff5ce;--fx3:#fff}.itemx2-skill-theme-arcane{--fx:#559ddb;--fx2:#9570d1;--fx3:#cce6ff}.itemx2-skill-type-active{--fx-speed:5.8s}.itemx2-skill-type-passive{--fx-speed:11s}.itemx2-skill-type-sealed{--fx-speed:18s}.itemx2-skill-status-equipped .itemx2-skill-hero-fx,.itemx2-skill-list-fx.itemx2-skill-status-equipped{opacity:1}.itemx2-skill-type-sealed .itemx2-skill-hero-fx,.itemx2-skill-status-sealed .itemx2-skill-hero-fx,.itemx2-skill-list-fx.itemx2-skill-type-sealed,.itemx2-skill-list-fx.itemx2-skill-status-sealed{opacity:.38;filter:saturate(.5) brightness(.72)}.itemx2-skill-status-lost .itemx2-skill-hero-fx,.itemx2-skill-list-fx.itemx2-skill-status-lost{opacity:.18;filter:grayscale(.78) brightness(.6)}.itemx2-skill-status-lost .itemx2-skill-hero-fx *{animation:none!important}
.itemx2-skill-theme-fire.itemx2-skill-list-fx{background:radial-gradient(ellipse at 88% 82%,rgba(255,91,38,.23),transparent 39%),radial-gradient(ellipse at 96% 52%,rgba(255,196,92,.16),transparent 24%),linear-gradient(154deg,transparent 65%,rgba(255,109,43,.1))}.itemx-skill-hero.itemx2-skill-theme-fire{background:radial-gradient(ellipse at 50% 70%,rgba(255,92,34,.18),transparent 34%),linear-gradient(145deg,#1b1414,#090d15 72%)}.itemx-skill-hero.itemx2-skill-theme-fire .itemx2-skill-hero-fx i{left:20%;right:20%;bottom:-8%;height:68%;border-radius:48% 52% 34% 39%/65% 62% 33% 35%;background:radial-gradient(ellipse at 48% 76%,rgba(255,198,91,.74),transparent 19%),radial-gradient(ellipse at 35% 62%,rgba(255,91,34,.56),transparent 45%),radial-gradient(ellipse at 68% 55%,rgba(215,47,28,.38),transparent 48%);filter:blur(13px)}.itemx-skill-hero.itemx2-skill-theme-fire .itemx2-skill-hero-fx b{left:27%;right:24%;bottom:3%;height:58%;border-radius:41% 59% 35% 42%/67% 58% 42% 33%;background:radial-gradient(ellipse at 42% 80%,rgba(255,220,122,.72),transparent 18%),radial-gradient(ellipse at 58% 66%,rgba(255,113,48,.52),transparent 41%),radial-gradient(ellipse at 30% 43%,rgba(218,53,31,.25),transparent 43%);clip-path:polygon(8% 100%,18% 57%,31% 79%,43% 18%,55% 68%,72% 36%,83% 75%,96% 53%,100% 100%);animation:itemx2-fire-breathe var(--fx-speed) ease-in-out infinite alternate}.itemx-skill-hero.itemx2-skill-theme-fire .itemx2-skill-hero-fx em{inset:15% 12% 20%;background:radial-gradient(circle at 21% 79%,rgba(255,219,118,.75) 0 2px,transparent 3px),radial-gradient(circle at 71% 63%,rgba(255,158,63,.64) 0 2px,transparent 3px),radial-gradient(circle at 83% 29%,rgba(255,221,127,.58) 0 1px,transparent 2px),radial-gradient(circle at 42% 22%,rgba(255,135,54,.48) 0 1px,transparent 2px);animation:itemx2-fire-embers calc(var(--fx-speed) * .9) linear infinite}
.itemx2-skill-theme-ice.itemx2-skill-list-fx{background:linear-gradient(126deg,transparent 67%,rgba(150,234,247,.14) 68% 77%,transparent 78%),linear-gradient(48deg,transparent 76%,rgba(135,164,238,.14) 77% 84%,transparent 85%),radial-gradient(ellipse at 91% 48%,rgba(93,198,222,.12),transparent 34%)}.itemx-skill-hero.itemx2-skill-theme-ice{background:radial-gradient(ellipse at 50% 47%,rgba(88,192,220,.15),transparent 37%),linear-gradient(145deg,#101b25,#080e16 72%)}.itemx-skill-hero.itemx2-skill-theme-ice .itemx2-skill-hero-fx i{left:20%;right:18%;top:17%;bottom:12%;border-radius:44% 56% 49% 51%;background:radial-gradient(ellipse,rgba(94,214,235,.2),transparent 68%);filter:blur(14px)}.itemx-skill-hero.itemx2-skill-theme-ice .itemx2-skill-hero-fx b{left:24%;top:11%;width:58%;height:71%;background:linear-gradient(145deg,rgba(222,252,255,.25),rgba(113,181,230,.08) 48%,rgba(121,137,215,.16));clip-path:polygon(48% 0,91% 23%,77% 69%,55% 100%,18% 82%,4% 37%);box-shadow:inset 10px -8px 25px rgba(106,191,224,.08);animation:itemx2-ice-float var(--fx-speed) ease-in-out infinite alternate}.itemx-skill-hero.itemx2-skill-theme-ice .itemx2-skill-hero-fx em{inset:15%;background:linear-gradient(127deg,transparent 42%,rgba(214,252,255,.5) 42.6% 43.2%,transparent 43.8%),linear-gradient(51deg,transparent 61%,rgba(153,220,242,.4) 61.5% 62%,transparent 62.5%),linear-gradient(105deg,transparent 72%,rgba(183,210,255,.28) 72.5% 73%,transparent 73.5%);opacity:.66}
.itemx2-skill-theme-lightning.itemx2-skill-list-fx{background:radial-gradient(ellipse at 91% 50%,rgba(137,183,255,.16),transparent 34%),linear-gradient(118deg,transparent 70%,rgba(242,240,132,.32) 71% 72%,transparent 73% 77%,rgba(138,191,255,.24) 78% 79%,transparent 80%);animation:itemx2-lightning-quiet calc(var(--fx-speed) * .85) steps(1,end) infinite}.itemx-skill-hero.itemx2-skill-theme-lightning{background:radial-gradient(ellipse at 50% 44%,rgba(103,155,224,.12),transparent 34%),linear-gradient(145deg,#121824,#080d15 72%)}.itemx-skill-hero.itemx2-skill-theme-lightning .itemx2-skill-hero-fx i{left:20%;right:20%;top:18%;bottom:14%;border-radius:46%;background:radial-gradient(ellipse,rgba(137,190,255,.22),transparent 67%);filter:blur(13px)}.itemx-skill-hero.itemx2-skill-theme-lightning .itemx2-skill-hero-fx b{left:10%;top:15%;width:49%;height:70%;background:linear-gradient(180deg,rgba(255,255,229,.95),rgba(224,235,109,.8) 45%,rgba(106,169,255,.68));clip-path:polygon(58% 0,42% 39%,61% 35%,22% 100%,38% 57%,16% 60%);opacity:.18;animation:itemx2-lightning-strike calc(var(--fx-speed) * .72) steps(1,end) infinite}.itemx-skill-hero.itemx2-skill-theme-lightning .itemx2-skill-hero-fx em{right:8%;top:24%;width:45%;height:58%;background:linear-gradient(160deg,rgba(155,206,255,.74),rgba(241,239,121,.52));clip-path:polygon(72% 0,46% 38%,64% 35%,26% 100%,43% 57%,22% 61%);opacity:.12;animation:itemx2-lightning-strike calc(var(--fx-speed) * .91) .31s steps(1,end) infinite}
.itemx2-skill-theme-dark.itemx2-skill-list-fx{background:radial-gradient(ellipse at 89% 55%,rgba(9,5,17,.68),transparent 42%),radial-gradient(ellipse at 96% 42%,rgba(115,61,150,.2),transparent 32%)}.itemx-skill-hero.itemx2-skill-theme-dark{background:radial-gradient(ellipse at 50% 43%,rgba(4,2,9,.72),transparent 28%),radial-gradient(ellipse at 50% 48%,rgba(86,45,117,.17),transparent 45%),linear-gradient(145deg,#12101c,#070a10 74%)}.itemx-skill-hero.itemx2-skill-theme-dark .itemx2-skill-hero-fx i{left:20%;right:17%;top:18%;bottom:13%;border-radius:46% 54% 42% 58%/55% 43% 57% 45%;background:#05030a;box-shadow:0 0 45px rgba(81,40,111,.38),-18px 8px 34px rgba(39,25,73,.28);filter:blur(5px)}.itemx-skill-hero.itemx2-skill-theme-dark .itemx2-skill-hero-fx b{left:14%;top:10%;width:76%;height:78%;border-radius:61% 39% 57% 43%/48% 58% 42% 52%;background:radial-gradient(ellipse at 62% 46%,transparent 36%,rgba(105,51,137,.17) 49%,transparent 69%);animation:itemx2-dark-draw var(--fx-speed) ease-in-out infinite alternate}.itemx-skill-hero.itemx2-skill-theme-dark .itemx2-skill-hero-fx em{right:13%;top:22%;width:44%;height:58%;border-radius:57% 43% 62% 38%;background:radial-gradient(ellipse at 36% 50%,transparent 53%,rgba(207,105,224,.37) 56%,transparent 64%);clip-path:polygon(40% 0,100% 8%,83% 93%,22% 100%,48% 66%,59% 32%);opacity:.7}
.itemx2-skill-theme-light.itemx2-skill-list-fx{background:radial-gradient(ellipse at 90% 50%,rgba(255,246,210,.2),transparent 38%),linear-gradient(112deg,transparent 72%,rgba(255,239,177,.16))}.itemx-skill-hero.itemx2-skill-theme-light{background:radial-gradient(ellipse at 50% 42%,rgba(255,245,208,.18),transparent 38%),linear-gradient(145deg,#1b1a19,#0a0e14 74%)}.itemx-skill-hero.itemx2-skill-theme-light .itemx2-skill-hero-fx i{left:18%;right:18%;top:16%;bottom:12%;border-radius:56% 44% 52% 48%;background:radial-gradient(ellipse,rgba(255,248,219,.38),rgba(235,207,137,.12) 44%,transparent 72%);filter:blur(14px)}.itemx-skill-hero.itemx2-skill-theme-light .itemx2-skill-hero-fx b{left:19%;right:18%;top:12%;height:67%;background:radial-gradient(ellipse at 50% 48%,transparent 42%,rgba(255,246,210,.31) 48%,transparent 66%);clip-path:polygon(10% 16%,78% 0,100% 76%,61% 100%,4% 73%);animation:itemx2-light-drift var(--fx-speed) ease-in-out infinite alternate}.itemx-skill-hero.itemx2-skill-theme-light .itemx2-skill-hero-fx em{inset:10% 9% 15%;background:radial-gradient(circle at 19% 70%,rgba(255,250,226,.7) 0 1px,transparent 2px),radial-gradient(circle at 75% 24%,rgba(255,240,188,.58) 0 1px,transparent 2px),radial-gradient(circle at 88% 69%,rgba(255,252,231,.48) 0 1px,transparent 2px),linear-gradient(104deg,transparent 44%,rgba(255,244,207,.13) 45% 47%,transparent 48%)}
.itemx2-skill-theme-arcane.itemx2-skill-list-fx{background:radial-gradient(ellipse at 91% 52%,rgba(75,126,201,.15),transparent 38%),radial-gradient(circle at 80% 34%,rgba(177,137,231,.38) 0 1px,transparent 2px),radial-gradient(circle at 94% 70%,rgba(105,174,223,.35) 0 1px,transparent 2px),linear-gradient(136deg,transparent 72%,rgba(124,91,184,.16))}.itemx-skill-hero.itemx2-skill-theme-arcane{background:radial-gradient(ellipse at 50% 44%,rgba(61,111,185,.16),transparent 38%),linear-gradient(145deg,#111729,#080c17 74%)}.itemx-skill-hero.itemx2-skill-theme-arcane .itemx2-skill-hero-fx i{left:17%;right:17%;top:15%;bottom:13%;border-radius:51% 49% 44% 56%;background:radial-gradient(ellipse,rgba(68,130,205,.2),rgba(94,59,156,.09) 48%,transparent 72%);filter:blur(13px)}.itemx-skill-hero.itemx2-skill-theme-arcane .itemx2-skill-hero-fx b{left:13%;top:13%;width:75%;height:72%;background:radial-gradient(circle at 17% 63%,rgba(158,205,255,.65) 0 1px,transparent 2px),radial-gradient(circle at 74% 18%,rgba(187,148,239,.62) 0 1px,transparent 2px),radial-gradient(circle at 88% 72%,rgba(117,183,227,.55) 0 1px,transparent 2px),linear-gradient(128deg,transparent 26%,rgba(119,171,225,.2) 27%,transparent 28% 67%,rgba(173,130,223,.18) 68%,transparent 69%);clip-path:polygon(0 16%,74% 0,100% 58%,68% 100%,12% 84%);animation:itemx2-arcane-parallax var(--fx-speed) ease-in-out infinite alternate}.itemx-skill-hero.itemx2-skill-theme-arcane .itemx2-skill-hero-fx em{right:12%;top:24%;width:48%;height:54%;background:radial-gradient(ellipse at 28% 50%,transparent 49%,rgba(167,126,222,.27) 52%,transparent 60%);clip-path:polygon(39% 0,100% 19%,83% 100%,6% 76%);opacity:.74}
.itemx-monster-hero{border-color:#3d4553;background:radial-gradient(ellipse at 50% 44%,rgba(107,121,145,.1),transparent 38%),linear-gradient(145deg,#151a22,#090d14 74%);box-shadow:inset 0 0 48px rgba(38,48,65,.12),0 12px 34px rgba(0,0,0,.36)}.itemx-monster-portrait{filter:none}.itemx-monster-hero .itemx-threat-banner{border-color:rgba(137,151,172,.36);background:rgba(17,22,31,.82);color:#9eacbf}.itemx2-encounter-warning .itemx-threat-banner{border-color:rgba(255,103,126,.48);background:rgba(48,12,20,.82);color:#ff9aab}.itemx2-encounter-sparring .itemx-threat-banner{border-color:rgba(215,174,92,.44);background:rgba(45,34,15,.82);color:#e9c779}
.itemx2-encounter-theme-beast{--fx:#c98a4c;--fx2:#8f3f38}.itemx2-encounter-theme-undead{--fx:#78ac9f;--fx2:#687681}.itemx2-encounter-theme-construct{--fx:#6f9eb2;--fx2:#b0c6cb}.itemx2-encounter-theme-dragon{--fx:#d85d3e;--fx2:#d3a34d}.itemx2-encounter-theme-aquatic{--fx:#45a6bf;--fx2:#577fc1}.itemx2-encounter-theme-insect{--fx:#819b4d;--fx2:#b19754}.itemx2-encounter-theme-humanoid,.itemx2-encounter-theme-unknown{--fx:#7f8da3;--fx2:#9d7481}.itemx2-encounter-list-fx{opacity:.72}.itemx2-encounter-theme-beast.itemx2-encounter-list-fx{background:repeating-linear-gradient(71deg,transparent 0 19px,rgba(201,138,76,.18) 20px 21px,transparent 22px 31px),radial-gradient(ellipse at 91% 52%,rgba(47,24,21,.3),transparent 39%)}.itemx2-encounter-theme-undead.itemx2-encounter-list-fx{background:radial-gradient(ellipse at 89% 76%,rgba(102,158,145,.2),transparent 45%),linear-gradient(168deg,transparent 61%,rgba(108,119,126,.13))}.itemx2-encounter-theme-construct.itemx2-encounter-list-fx{background:repeating-linear-gradient(90deg,transparent 0 24px,rgba(109,160,180,.1) 25px),linear-gradient(90deg,transparent 76%,rgba(175,202,210,.15) 77% 79%,transparent 80%)}.itemx2-encounter-theme-dragon.itemx2-encounter-list-fx{background:radial-gradient(ellipse at 91% 72%,rgba(220,84,49,.22),transparent 43%),repeating-radial-gradient(ellipse at 96% 54%,rgba(214,157,72,.12) 0 5px,transparent 6px 13px)}.itemx2-encounter-theme-aquatic.itemx2-encounter-list-fx{background:radial-gradient(ellipse at 91% 43%,transparent 25%,rgba(77,174,198,.14) 27%,transparent 31%),linear-gradient(160deg,transparent 57%,rgba(73,129,190,.12))}.itemx2-encounter-theme-insect.itemx2-encounter-list-fx{background:radial-gradient(circle at 81% 31%,rgba(151,174,83,.24) 0 2px,transparent 3px),radial-gradient(circle at 91% 54%,rgba(177,147,73,.21) 0 2px,transparent 3px),radial-gradient(circle at 84% 77%,rgba(129,153,72,.19) 0 1px,transparent 2px)}.itemx2-encounter-theme-humanoid.itemx2-encounter-list-fx,.itemx2-encounter-theme-unknown.itemx2-encounter-list-fx{background:linear-gradient(145deg,transparent 62%,rgba(114,130,155,.11)),radial-gradient(ellipse at 92% 52%,rgba(117,86,101,.12),transparent 35%)}
.itemx2-encounter-theme-beast .itemx2-encounter-hero-fx i{inset:18% 16%;border-radius:52% 48% 43% 57%;background:radial-gradient(ellipse,rgba(31,19,18,.54),transparent 69%);filter:blur(12px)}.itemx2-encounter-theme-beast .itemx2-encounter-hero-fx b{inset:12% 8%;background:repeating-linear-gradient(71deg,transparent 0 42px,rgba(215,143,73,.22) 43px 45px,transparent 46px 64px);clip-path:polygon(47% 0,100% 7%,85% 100%,26% 91%,0 28%)}.itemx2-encounter-theme-beast .itemx2-encounter-hero-fx em{right:11%;bottom:12%;width:40%;height:42%;background:radial-gradient(ellipse,rgba(157,57,47,.2),transparent 67%)}
.itemx2-encounter-theme-undead .itemx2-encounter-hero-fx i{left:12%;right:12%;bottom:4%;height:67%;border-radius:53% 47% 41% 59%;background:radial-gradient(ellipse at 50% 70%,rgba(87,139,126,.25),transparent 64%);filter:blur(15px)}.itemx2-encounter-theme-undead .itemx2-encounter-hero-fx b{left:16%;right:14%;bottom:8%;height:58%;background:radial-gradient(ellipse at 24% 70%,rgba(126,181,165,.2),transparent 28%),radial-gradient(ellipse at 72% 52%,rgba(118,143,147,.17),transparent 34%);animation:itemx2-undead-haze 13s ease-in-out infinite alternate}.itemx2-encounter-theme-undead .itemx2-encounter-hero-fx em{left:25%;top:25%;width:17%;height:31%;border-radius:58% 42% 55% 45%;background:linear-gradient(rgba(153,214,194,.35),transparent);opacity:.54}
.itemx2-encounter-theme-construct .itemx2-encounter-hero-fx i{inset:12%;background:repeating-linear-gradient(90deg,transparent 0 34px,rgba(100,151,171,.08) 35px),repeating-linear-gradient(0deg,transparent 0 28px,rgba(174,198,204,.07) 29px)}.itemx2-encounter-theme-construct .itemx2-encounter-hero-fx b{left:8%;right:8%;top:29%;height:1px;background:linear-gradient(90deg,transparent,rgba(154,201,215,.62),transparent);box-shadow:0 0 10px rgba(89,155,178,.35);animation:itemx2-construct-scan 7s ease-in-out infinite}.itemx2-encounter-theme-construct .itemx2-encounter-hero-fx em{right:13%;top:16%;width:31%;height:12%;background:repeating-linear-gradient(90deg,rgba(164,194,202,.24) 0 9px,transparent 10px 15px)}
.itemx2-encounter-theme-dragon .itemx2-encounter-hero-fx i{left:15%;right:15%;bottom:2%;height:62%;border-radius:50% 50% 39% 44%;background:radial-gradient(ellipse at 50% 75%,rgba(211,75,42,.3),transparent 65%);filter:blur(14px)}.itemx2-encounter-theme-dragon .itemx2-encounter-hero-fx b{right:8%;top:14%;width:56%;height:72%;background:repeating-radial-gradient(ellipse at 100% 50%,rgba(213,158,72,.2) 0 7px,rgba(116,48,34,.08) 8px 15px,transparent 16px 22px);clip-path:polygon(31% 0,100% 0,100% 100%,5% 87%,34% 61%,9% 33%)}.itemx2-encounter-theme-dragon .itemx2-encounter-hero-fx em{inset:13% 10% 28%;background:radial-gradient(circle at 22% 77%,rgba(255,183,72,.55) 0 2px,transparent 3px),radial-gradient(circle at 77% 59%,rgba(222,83,43,.48) 0 2px,transparent 3px),radial-gradient(circle at 63% 21%,rgba(244,165,71,.4) 0 1px,transparent 2px);animation:itemx2-fire-embers 10s linear infinite}
.itemx2-encounter-theme-aquatic .itemx2-encounter-hero-fx i{inset:15%;border-radius:48%;background:radial-gradient(ellipse,rgba(57,143,174,.22),transparent 66%);filter:blur(14px)}.itemx2-encounter-theme-aquatic .itemx2-encounter-hero-fx b{inset:13% 8%;background:radial-gradient(ellipse at 30% 35%,transparent 30%,rgba(102,211,224,.16) 32%,transparent 36%),radial-gradient(ellipse at 73% 67%,transparent 24%,rgba(82,145,211,.15) 26%,transparent 31%);animation:itemx2-aquatic-caustic 12s ease-in-out infinite alternate}.itemx2-encounter-theme-aquatic .itemx2-encounter-hero-fx em{left:7%;right:7%;bottom:13%;height:22%;background:repeating-radial-gradient(ellipse at 50% 100%,transparent 0 20px,rgba(113,207,220,.13) 22px,transparent 24px 34px);opacity:.68}
.itemx2-encounter-theme-insect .itemx2-encounter-hero-fx i{inset:16%;background:radial-gradient(ellipse,rgba(91,108,49,.17),transparent 68%);filter:blur(12px)}.itemx2-encounter-theme-insect .itemx2-encounter-hero-fx b{inset:13%;background:radial-gradient(circle at 18% 28%,rgba(153,178,85,.31) 0 3px,transparent 4px),radial-gradient(circle at 34% 72%,rgba(181,151,75,.27) 0 2px,transparent 3px),radial-gradient(circle at 72% 24%,rgba(128,151,70,.25) 0 3px,transparent 4px),radial-gradient(circle at 84% 66%,rgba(169,143,72,.23) 0 2px,transparent 3px),radial-gradient(circle at 58% 48%,rgba(115,137,64,.2) 0 2px,transparent 3px);mask:linear-gradient(128deg,#000 20%,transparent 88%);animation:itemx2-insect-drift 14s ease-in-out infinite alternate}.itemx2-encounter-theme-insect .itemx2-encounter-hero-fx em{right:13%;top:18%;width:31%;height:53%;background:repeating-linear-gradient(60deg,transparent 0 11px,rgba(181,154,82,.13) 12px,transparent 13px 22px)}
.itemx2-encounter-theme-humanoid .itemx2-encounter-hero-fx i,.itemx2-encounter-theme-unknown .itemx2-encounter-hero-fx i{inset:18%;border-radius:52% 48% 45% 55%;background:radial-gradient(ellipse,rgba(84,98,121,.17),transparent 68%);filter:blur(13px)}.itemx2-encounter-theme-humanoid .itemx2-encounter-hero-fx b,.itemx2-encounter-theme-unknown .itemx2-encounter-hero-fx b{inset:14% 10%;background:linear-gradient(135deg,transparent 52%,rgba(139,153,175,.1) 53%,transparent 54%),linear-gradient(45deg,transparent 69%,rgba(143,106,125,.09) 70%,transparent 71%);clip-path:polygon(6% 18%,76% 0,100% 68%,64% 100%,0 77%)}.itemx2-encounter-theme-humanoid .itemx2-encounter-hero-fx em,.itemx2-encounter-theme-unknown .itemx2-encounter-hero-fx em{right:14%;bottom:14%;width:39%;height:35%;background:radial-gradient(ellipse,rgba(141,102,121,.12),transparent 69%)}
.itemx2-encounter-warning .itemx2-encounter-hero-fx::after{content:'';position:absolute;left:6%;right:6%;top:13%;height:2px;background:linear-gradient(90deg,transparent,rgba(255,88,112,.82),transparent);box-shadow:0 0 18px rgba(255,51,82,.5);animation:itemx2-combat-warning 3.6s ease-in-out infinite}.itemx2-encounter-sparring .itemx2-encounter-hero-fx::after{background:linear-gradient(90deg,transparent,rgba(224,183,94,.66),transparent);box-shadow:0 0 14px rgba(202,158,72,.34);animation-duration:6.5s}.itemx2-encounter-ended .itemx2-encounter-hero-fx{opacity:.24;filter:grayscale(.6)}.itemx2-encounter-ended .itemx2-encounter-hero-fx *,.itemx2-encounter-ended .itemx2-encounter-hero-fx::after{animation:none!important}.itemx2-threat-1 .itemx2-encounter-hero-fx{opacity:.78}.itemx2-threat-2 .itemx2-encounter-hero-fx{opacity:.9}.itemx2-threat-3 .itemx2-encounter-hero-fx{opacity:1}
...
.itemx2-effects-off .itemx2-codex-fx{display:none!important;animation:none!important}.itemx2-effects-off .itemx2-codex-fx *{animation:none!important}@media(prefers-reduced-motion:reduce){.itemx2-codex-fx,.itemx2-codex-fx *{animation:none!important}}
`;
...
`;
  ...
  function skillFxClasses(skill) {
    ...
    return `itemx2-skill-theme-${skillTheme(skill)} itemx2-skill-type-${type} itemx2-skill-status-${status}`;
  }
  ...
  function monsterPageHtml(monster, portrait, back) {
    ...
    return `<div class="itemx-codex-page itemx2-codex-page">${back}<section class="itemx-codex-hero itemx-monster-hero ${encounterFxClasses(monster)}">${codexHeroFx('encounter')}<b class="itemx-threat-banner">⚠️ THREAT · ${ITEMXCore.esc(monster.threat || '미상')}</b>${visual}<span class="itemx-codex-hero-copy"><small>⚔️ ENCOUNTER ARCHIVE</small><strong>${ITEMXCore.esc(monster.name)}</strong><span>${ITEMXCore.esc(monster.kind || '미분류')} · ${ITEMXCore.esc(monster.relation)} · ${ITEMXCore.esc(monster.status)}</span></span></section><div class="itemx-codex-stat-grid"><span class="itemx-codex-stat"><small>ENCOUNTERS</small><strong>⚔️ ${Number(monster.encounterCount) || 1}회</strong></span><span class="itemx-codex-stat"><small>COMBAT STATE</small><strong>${monster.active ? '🔥 현재 교전 기록' : '📖 보관 기록'}</strong></span></div>${monster.description ? `<section class="itemx-codex-section"><h4>👁️ 관찰 기록</h4><p>${ITEMXCore.esc(monster.description)}</p></section>` : ''}${chips('🏷️ 별칭', monster.aliases, '없음')}${chips('🎯 확인된 약점', monster.weaknesses, '미상')}${chips('🛡️ 확인된 내성', monster.resistances, '미상')}${chips('💥 관측 행동', monster.moves, '미상')}<section class="itemx-codex-section"><small>ID · ${ITEMXCore.esc(monster.id)}</small></section></div>`;
  }
