...
@media(max-width:520px){.itemx2-root-drawer .itemx2-root-panel{width:calc(100vw - 16px);max-width:none;height:min(900px,88dvh)}.itemx2-root-pos-lb,.itemx2-root-pos-lm,.itemx2-root-pos-lt{left:8px;right:auto;top:auto;bottom:8px;transform:none}.itemx2-root-pos-rb,.itemx2-root-pos-rm,.itemx2-root-pos-rt{right:8px;left:auto;top:auto;bottom:8px;transform:none}.itemx2-root-drawer[class*='itemx2-pos-'] .itemx2-root-panel{left:8px;right:auto}}
