...
export const runtimeModules = ['runtime-config', 'style', 'ui-settings', 'portraits', 'ledger', 'aux', 'pipeline', 'presentation', 'ui-panel'];
export async function runtimeSource() {
  ...
  return bootstrap.replace('/* ITEMX_MODULES */', modules.join('\n'));
}
